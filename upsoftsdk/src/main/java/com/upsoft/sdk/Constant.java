...
//    public static String IP = "http://" + CURRENT_IP;//IP地址
    ...
    public static void buildFile() {
        DIR_PATH = Environment.getExternalStorageDirectory() + "/upsoft" + (StringUtil.isBlank
    ...
    public static void clearChche(){
        FileUtil.deleteFile(Constant.DOWNLOAD_PATH);
        FileUtil.deleteFile(Constant.TEMPIM_PATH);
        FileUtil.deleteFile(Constant.VIDEO_PATH);
        FileUtil.deleteFile(Constant.AUDIO_PATH);
        FileUtil.deleteFile(Constant.CACHE_LOGE_PATH);
        FileUtil.deleteFile(Constant.WEEX_PATH);
    }
    ...
    public static class Url {
        ...
        //文件上传
        public static final String URL_UPLOAD_FILE = "/cgi/bp/filemgt/fileupload/upload";
        //上传日志关系数据
        public static final String URL_UPLOAD_LOG = "/cgi/bp/mobile/collapselogupload/add";
        //根据ID查询文件信息
        public static final String URL_GET_FILEINFO = "/cgi/bp/filemgt/fileupload/get";
    ...
    public static class Receiver {
        ...
        public static final String ACTION_TEXT_SIZE_CHANGE = "com.upsoft.sdk.action_text_size_change";//字体修改广播
    }
