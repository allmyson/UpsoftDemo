...
public class GalleryPagerAdapter extends PagerAdapter {
    ...
    public GalleryPagerAdapter(List<SkinBean> list, Context context) {
        this.list = list;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        imageView.setImageResource(list.get(position).drawableId);
        TextView nameTV = (TextView) view.findViewById(R.id.tv_name);
        nameTV.setText(StringUtil.valueOf(list.get(position).name));
        nameTV.setTextColor(Color.parseColor(list.get(position).color));
